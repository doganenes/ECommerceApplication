...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        User user1 = new User("ali049", "Ali", "Atasoy", "29/05/1977", "ab0495ya", "aliatasoy01@gmail.com", "Ata Street Izmir/Turkey", "Gungoren APT Izmir/Turkey");
        CreditCard creditCard1 = new CreditCard("123456789", user1, "0046", "05/2030");

        User user2 = new User("salih5468", "Salih", "Gün", "26/02/1996", "562455aa", "saligün096@gmail.com", "Vega BLVD Istanbul/Turkey", "Maslak İstanbul/Turkey");
        CreditCard creditCard2 = new CreditCard("656838763", user2, "0523", "03/2024");

        User user3 = new User("ezgi5684", "Ezgi", "Yaman", "04/04/1989", "d55678c8", "ezgi553@gmail.com", "Palas APT Denizli/Turkey", "Maslak İstanbul/Turkey");
        ...
        user2.addFavouriteProducts(steak);
